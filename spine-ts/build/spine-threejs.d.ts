...
declare namespace spine {
	class AssetManager implements Disposable {
		...
		loadBinary(path: string, success?: (path: string, data: Uint8Array) => void, error?: (path: string, error: string) => void): void;
...
declare namespace spine {
	export class SkeletonBinary {
		...
		readAttachment(e: BinaryInput, r: Skin, i: number, a: string, o: SkeletonData, s: boolean): RegionAttachment | MeshAttachment | BoundingBoxAttachment | PathAttachment | PointAttachment | ClippingAttachment;
...
declare namespace spine.threejs {
